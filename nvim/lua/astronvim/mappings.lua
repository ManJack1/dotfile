...
local sections = {
  ...
  J = { desc = get_icon("ChatGPT", 1, true) .. "ChatGPT" },
  a = { desc = get_icon("neoai", 1, true) .. "neoai" },
}
...
if is_available "ChatGPT.nvim" then
  ...
  maps.n["<leader>Jo"] = { "<cmd>ChatGPT<cr>", desc = "open ChatGPT" }
  maps.n["<leader>Ja"] = { "<cmd>ChatGPTAct<cr>", desc = "ChatGPTActAs" }
  maps.n["<leader>Jc"] = { "<cmd>ChatGPTCompleteCode<cr>", desc = "ChatGPTCompleteCode" }
  maps.n["<leader>Ji"] = { "<cmd>ChatGPTEditWithInstructions<cr>", desc = "ChatGPTEditWithInstructions" }
end

--neoai
if is_available "neoai.nvim" then
  maps.n["<leader>a"] = sections.a
  maps.n["<leader>ao"] = { "<cmd>NeoAI<cr>", desc = "open ChatGPT" }
  maps.n["<leader>ac"] = { "<cmd>NeoAIClose<cr>", desc = "Close ChatGPT" }
end
